        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-sm-12 col-lg-6 text-center">
                ...
                <ul class="list-inline footer-social">
                    ...
                    <li class="li list-inline-item"><a href="https://twitter.com/themefisher"><i class="fab fa-twitter"></i></a></li>
                    <li class="li list-inline-item"><a href="#"><i class="fab fa-linkedin"></i></a></li>
                    <li class="li list-inline-item"><a href="#"><i class="fab fa-pinterest"></i></a></li>
                    <li class="li list-inline-item"><a href="#"><i class="fa fa-rss"></i></a></li>
                    <li class="li list-inline-item"><a href="#"><i class="fab fa-youtube"></i></a></li>
                </ul>
