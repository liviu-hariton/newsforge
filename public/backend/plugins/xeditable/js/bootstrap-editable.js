...
(function ($) {
    ...
    */      
    ...
    '<div><div class="editable-input"></div><div class="editable-buttons"></div><span class="editable-error-block"></span></div>'+
    '</div>' +
    '</form>';
...
(function ($) {
    ...
    $.extend($.fn.editableform.Constructor.prototype, {
        initTemplate: function() {
            ...
            this.$form.find('.editable-error-block').addClass('form-text');
            this.$form.find('.editable-error-block').addClass('text-danger');
            this.$form.find('.editable-error-block').addClass('fs-12');
        },
        initInput: function() {  
    ...
    $.fn.editableform.buttons = 
      '<button type="submit" class="btn btn-secondary btn-sm editable-submit">'+
